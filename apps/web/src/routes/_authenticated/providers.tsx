...
function ProvidersPage() {
  ...
  return (
    <div className="flex h-svh flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6"><div className="mx-auto w-full max-w-7xl">
                ...
                <CardContent className="flex items-center justify-between p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className="bg-purple-100 text-purple-700 dark:bg-purple-950 dark:text-purple-400">{provider.category}</Badge>
                    </div>
